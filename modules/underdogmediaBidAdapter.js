...
let UDM_ADAPTER_VERSION = '1.38-4.8.0C';
let PREBID_VERSION = $$PREBID_GLOBAL$$.version;
let PREBID_NAME = '$$PREBID_GLOBAL$$';
let UDM_VENDOR_ID = '159';
let LATEST_TEST_DATE = '2020-09-18';

let UnderdogMediaAdapter = function UnderdogMediaAdapter() {
  utils.logMessage(`Initializing UDM Adapter. Global Prebid Name:$$PREBID_GLOBAL$$ PBJS Version:${$$PREBID_GLOBAL$$.version} with adapter version:${UDM_ADAPTER_VERSION}  Updated/tested:${LATEST_TEST_DATE}`);
